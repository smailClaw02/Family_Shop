...
function CommandCreate() {
    ...
    return (
        <div>
            {/* title */}
            <div id="content" className="pt-4 text-primary border-bottom border-5 border-primary shadow-sm p-3 text-start h1 rounded-4">
                New Order
            </div>
            {/* body */}
            <div id="content" className="my-4 w-100 card shadow">
                <form className="row m-2" onSubmit={onCreate}>
                    ...
                    <div className="row my-2 mx-0 p-4 shadow">
                        ...
                        <div className="col-4">
                            <TextField
                                label="Telephone"
                                type="tel"
                                placeholder="Enter telephone +212..."
                                value={client_phone}
                    ...
                    <div className="row mt-4 m-0 py-3 align-items-center">
                        <div className='h2 text-start'>Products</div>
